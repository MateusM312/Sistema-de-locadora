...
struct NoFilmes{
    ...
    vector<Clientes> listaEspera; // a nossa ideia é que isso seja uma fila q guarde as pessoas q querem alugar o disco
    NoFilmes* prox;
};
...
// busca linear por enquanto, mas eu vou mudar pra binaria assim q essa musica do kurt cobain acabar
...
void emprestarFilme(string tituloFilme, Clientes cliente){
    ...
    if (filmeEscolhido->emprestado == false){
        ...
        cout << "=========================================================\n";
        cout << endl;
        cout << "Filme está emprestado, você foi colocado na lista de espera\n";
        filmeEscolhido->listaEspera.push_back(cliente);
    ...
    do{
        ...
        case 7:
            ...
            do{
                ...
                choice = lerInt("Digite 1 para sair!: ");
            }while(choice != 1);
            break;
        case 0:
            system("cls");
